...
const AccordionHistoryDriver = ({ BookingDate, Latitude, Longitude, Notes, Mobile, Vehicle, FullName, Amount, HistoryKey, ClientLocation, TodaLocation}) => {
...
export default AccordionHistoryDriver