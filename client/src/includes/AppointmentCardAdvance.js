...
const AppointmentCardAdvance = ({AppointmentID,UserID,HeadCount,BookingDate,Notes,Latitude,Longitude,Location}) => {
  ...
  return (
    <Card
        ...
        <Card.Header>
          ...
          <Row>
            <Col>
            <p style={{fontSize:'16px', fontWeight:'bold', margin: '0'}}><DayJS  format="ddd DD MMM YYYY | HH:mmA">{BookingDate}</DayJS> </p>
            </Col>
          </Row>
        </Card.Header>
        <Card.Body>
...
export default AppointmentCardAdvance